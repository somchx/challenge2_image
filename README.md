...
หนังสือเรียนตั้งพิงกับผนัง กล้อง tilt ช้าๆ

---

### e2 — Printed A4 poster
...
โปสเตอร์ A4 ติดผนัง กล้อง pan ซ้าย-ขวาช้าๆ
...
**ผลที่คาดหวัง:** ไม่พบ keypoint บนผนังขาวเรียบ → ไม่ detect

---

### f2 — Solid-color t-shirt

| Output frame | Output GIF |
|---|---|
| ![f2 detected](outputs/expected_fail/output_f2.png) | ![f2 gif](outputs/expected_fail/output_f2.gif) |

**ผลที่คาดหวัง:** เสื้อยืดสีล้วน ไม่มี feature → ไม่ detect
