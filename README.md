...
ปัจจัยสำคัญอีกอย่างที่ทำให้กลุ่มนี้ detect ได้ดีคือ **template ทุกเคสตัดมาจากวิดีโอโดยตรง** ทำให้ลักษณะของวัตถุในภาพ เช่น สี แสง มุมมอง และ texture ตรงกับสิ่งที่ระบบต้องไป match ในวิดีโอได้เป๊ะมากกว่าการใช้ภาพจากแหล่งอื่น
...
### d2 — POP MART Logo — Flat Design, Few Keypoints & Real-world Capture
...
**ที่มา:** ถ่ายเอง  
**วัตถุเป้าหมาย:** โลโก้ POP MART (ตัวอักษรสีขาวบนพื้นแดง)  
**Template:** `outputs/difficult/output_d2.png`  
**Video:** `videos/difficult/video_d2.mp4`  
**Parameters:** ratio=0.70, min_matches=8, min_inliers=6, ransac_thresh=5.0

**อธิบายผลลัพธ์:**  
เคสนี้ยากในแบบที่ต่างออกไปจากเคสอื่น เพราะโลโก้ POP MART เป็น flat design ล้วน พื้นสีแดงทึบ ตัวอักษรสีขาวไม่มี gradient หรือ texture ซับซ้อน ทำให้ระบบหา keypoint ได้เพียง 112 จุดเท่านั้น น้อยกว่าเคสอื่นอย่างเห็นได้ชัด อีกปัจจัยหนึ่งคือ template นำมาจากอินเทอร์เน็ต ส่วนวิดีโอถ่ายเองในสภาพแสงและมุมมองจริง ทำให้ความสว่าง ความคมชัด และสีของโลโก้ในวิดีโออาจไม่ตรงกับ template อย่างสมบูรณ์ อย่างไรก็ตาม เนื่องจากโครงสร้างของโลโก้คงรูปและขอบตัวอักษรมี contrast สูง SIFT จึงยังจับ keypoint บริเวณขอบได้เพียงพอ และระบบสามารถ detect โลโก้ในวิดีโอจริงได้ แม้ภาพจะไม่ได้คมชัดมากนัก

---

### d3 — UNIQLO Logo on Glass — Reflective Surface, Tilt & Rotation
...
**ที่มา:** ถ่ายเอง  
**วัตถุเป้าหมาย:** โลโก้ UNIQLO ที่เพ้นลงบนแก้วทรงกระบอก  
...
**อธิบายผลลัพธ์:**  
เคสนี้มีปัจจัยรบกวนหลายอย่างซ้อนกัน ประการแรกคือ template นำมาจากอินเทอร์เน็ตซึ่งเป็นภาพโลโก้แบน พื้นขาว ตัวอักษรดำชัดเจน ระบบหา keypoint ได้เพียง 99 จุดเท่านั้น แต่ในวิดีโอที่ถ่ายเองโลโก้ถูกเพ้นลงบนผิวแก้วทรงกระบอกที่มีความเงา ทำให้แสงสะท้อนบนผิวแก้วเปลี่ยน appearance ของโลโก้ไปจาก template อยู่ตลอดเวลา ประการที่สองคือแก้วมีการหมุนและเอียงระหว่างถ่ายวิดีโอ ทำให้มุมมองของโลโก้เปลี่ยนไปเรื่อย ๆ เกิด perspective distortion และบางช่วงโลโก้โค้งตามผิวแก้ว 
อย่างไรก็ตาม ขอบตัวอักษรและรูปตัดของโลโก้ทั้งสองเวอร์ชัน (ภาษาญี่ปุ่นและภาษาอังกฤษ) ยังคงให้ gradient ที่ชัดพอสำหรับ SIFT และระบบก็สามารถ detect โลโก้ในวิดีโอได้ในหลายช่วง แม้ความคมชัดและมุมมองจะไม่ตรงกับ template เป๊ะ
...
**อธิบายผลลัพธ์:**  
ธงเป็นวัตถุที่เปลี่ยนรูปตลอดเวลาเพราะโดนลมพัด บางจังหวะมีการพับ บิด หรือบังกันเอง ทำให้ลวดลายบนธงไม่เหมือนกับภาพต้นแบบแบบต่อเนื่อง ไม่สามารถ detect ได้สำเร็จ สาเหตุหลักมาจากวัตถุประเภทผ้าที่ไม่คงรูป ซึ่งไม่ค่อยเหมาะกับการจับคู่แบบ template-based matching
...
**อธิบายผลลัพธ์:**  
เคสนี้ตอนแรกดูน่าจะผ่านมากที่สุดในกลุ่มนี้ เพราะ template ตัดมาจากวิดีโอโดยตรง ภาพคมชัด พื้นหลังสีขาวเรียบ และเครื่องประดับมีรายละเอียดสูงมาก ระบบก็หา keypoint บน template ได้ถึง 1,150 จุด แต่พอทดลองกับวิดีโอ กลับพบว่าการ detect เกิดขึ้นแค่บางช่วง โดยเฉพาะตอนที่มุมมองและแสงใกล้กับภาพต้นแบบ พอเครื่องประดับหมุนหรือแสงสะท้อนเปลี่ยน ตำแหน่ง highlight บนผิวทองและอัญมณีก็เปลี่ยนตาม ทำให้ descriptor หลายจุดไม่เหมือนเดิมอีกต่อไป อีกประเด็นคือเครื่องประดับเป็นวัตถุ 3 มิติ ไม่ได้แบนเหมือนกระดาษหรือซองขนม ดังนั้นพอเปลี่ยนมุม กลุ่มลายที่เห็นในภาพก็เปลี่ยนตามไปด้วย สรุปคือเคสนี้แสดงให้เห็นว่า **แม้ template จะมาจากวิดีโอโดยตรงและมีคุณภาพดีเพียงใด จำนวน keypoint เยอะก็ไม่ได้แปลว่าจะ detect ได้เสถียรเสมอไป** หากวัตถุมีผิวสะท้อนแสงและเป็น 3 มิติ
...
**จำนวน keypoint บน template:** 4695 จุด
...
ยิ่งไปกว่านั้น template ที่ใช้เป็นภาพส้มที่นำมาจากอินเทอร์เน็ต ไม่ได้ตัดมาจากวิดีโอโดยตรง ทำให้ลักษณะผิว สี และพื้นผิวย่อยของส้มใน template ไม่ตรงกันเป๊ะกับส้มที่ปรากฏในวิดีโอ ความแตกต่างเล็กน้อยเหล่านี้ยิ่งซ้ำเติมให้ descriptor ที่อ่อนแออยู่แล้วยิ่ง match ได้ยากขึ้นไปอีก
...
**จำนวน keypoint บน template:** 889 จุด
...
ทั้งนี้ template ที่ใช้เป็นภาพปลาการ์ตูนที่นำมาจากอินเทอร์เน็ต ไม่ได้ตัดมาจากวิดีโอโดยตรง ลวดลายสีส้ม-ขาว-ดำและรูปทรงของปลาใน template จึงไม่ตรงกันเป๊ะกับตัวปลาที่ปรากฏในวิดีโอ เช่น สัดส่วนแถบสี ความกว้างของขอบดำ และรูปทรงครีบ อาจแตกต่างกันในแต่ละสายพันธุ์หรือแต่ละภาพ ความไม่ตรงกันนี้ยิ่งทำให้ระบบแยกปลาออกจากพื้นหลังที่มีสีใกล้เคียงกันได้ยากขึ้น

---

### u4 — Playing Card (6 of Hearts) — Template-Video Appearance Mismatch & Reflective Surface
...
**ที่มา:** ถ่ายเอง  
**วัตถุเป้าหมาย:** ไพ่ 6 หัวใจสีแดง  
**Template:** `templates/unexpected_fail/template_u4.jpg`  
**Video:** `videos/unexpected_fail/video_u4.mp4`  
**จำนวน keypoint บน template:** 77 จุด

**อธิบายผลลัพธ์:**  
template ที่ใช้ในเคสนี้คือภาพไพ่ 6 หัวใจสีแดงที่นำมาจากอินเทอร์เน็ต ซึ่งดูชัดเจนและมีรายละเอียดครบถ้วน ทั้งตัวเลข สัญลักษณ์หัวใจ และพื้นหลังสีขาว ระบบสามารถตรวจจับ keypoint บน template ได้พอสมควร แต่พอนำไป match กับวิดีโอจริงที่ถ่ายเองกลับ detect ไม่ได้เลย เนื่องจากไพ่ในวิดีโอมีแสงสะท้อนบนผิวมัน มุมมองที่เอียงหรือบิดเบี้ยว และสีที่ไม่ตรงกับ template จากเน็ตซึ่งถ่ายในสภาพแสงและมุมที่ต่างออกไปโดยสิ้นเชิง ทำให้ descriptor ที่ระบบสร้างจาก template กับสิ่งที่เห็นในวิดีโอจริงห่างกันเกินกว่าจะ match กันได้ เคสนี้สะท้อนให้เห็นว่าแม้ template จะดูชัดและมีรายละเอียดมาก แต่ถ้าไม่ได้มาจากวิดีโอโดยตรง ความแตกต่างของ appearance ก็อาจทำให้ระบบล้มเหลวได้ทั้งหมด
...
**จำนวน keypoint บน template:** 168 จุด
...
ปัจจัยเสริมอีกอย่างคือ template ที่ใช้เป็นภาพมดจากอินเทอร์เน็ต ไม่ได้ตัดมาจากวิดีโอโดยตรง ลักษณะของตัวมดใน template เช่น สัดส่วน ท่าทาง มุมมอง จึงไม่ตรงกันเป๊ะกับมดในวิดีโอ
