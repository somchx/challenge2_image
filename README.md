...
ปัจจัยเสริมอีกอย่างคือ template ที่ใช้เป็นภาพมดจากอินเทอร์เน็ต ไม่ได้ตัดมาจากวิดีโอโดยตรง ลักษณะของตัวมดใน template เช่น สัดส่วน ท่าทาง มุมมอง และสีของโครงกระดูกภายนอก จึงไม่ตรงกันเป๊ะกับมดในวิดีโอ ความแตกต่างของ appearance ระหว่างสายพันธุ์หรือสภาพแสงที่ถ่ายต่างกัน ทำให้ descriptor ที่ได้ไม่ robust พอสำหรับการ track มดตัวเดิมในทุกเฟรม
